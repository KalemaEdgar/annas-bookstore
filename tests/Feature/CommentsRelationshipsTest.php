...
class CommentsRelationshipsTest extends TestCase
{
    ...
    /** @test */
    public function just_so_that_this_class_has_no_test()
    {
    ...
    //                 'users' => [
    //                     'links' => [
    //                         'self' => route('comments.relationships.users', ['comment' => $comment->id]),
    //                         'related' => route('comments.users', ['comment' => $comment->id]),
    //                     ],
    //                     'data' => [
    //                         'id' => $user->id,
    //                         'type' => 'users',
